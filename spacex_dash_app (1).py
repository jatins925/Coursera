...
app.layout = html.Div(children=[
                                ...
                                html.Div([
                                         html.Div([
                                            # Create an division for adding dropdown helper text for launch site
                                             html.Div([
                                                ...
                                                {'label': 'site1: CCAFS LC-40', 'value': 'CCAFS LC-40'},
                                                {'label': 'site2: VAFB SLC-4E', 'value': 'VAFB SLC-4E'},
                                                {'label': 'site3: KSC LC-39A', 'value': 'KSC LC-39A'},
                                                {'label': 'site4: CCAFS SLC-40', 'value': 'CCAFS SLC-40'}
                                                        ],
                                                value='ALL',
